...
# 
####
# File: 01_Dichte_und_Masse.py
# Project: Kapitel_10_Definition_eigener_Klassen
#-----
# Created Date: Wednesday 07.10.2020, 16:48
# Author: Apop85
#-----
# Last Modified: Wednesday 07.10.2020, 16:48
#-----
# Copyright (c) 2020 Apop85
# This software is published under the MIT license.
# Check http://www.opensource.org/licenses/MIT for further informations
#-----
# Description: Chapter 10. Page 310. Task to create a Class to calculate mass and density
####
...
# Überschreibe str um die Zahlen leserlich auszugeben
class str(str):
    def __init__(self, value):
        self.object = "{}".format(round(float(value), 2))

    def __str__(self):
        return self.object

def print_element_properties(element):
    print("Elementname:", element.getElementName())
    print("Dichte:", str((element.getDensity())))
    print("Elementvolumen:", str(element.getVolume()))
    print("Masse:", str((element.getMass())))


bowling_ball = Ding("fe", 15)
print_element_properties(bowling_ball)

bowling_ball.setElement("CU")
print_element_properties(bowling_ball)

bowling_ball.setVolume(20)
print_element_properties(bowling_ball)